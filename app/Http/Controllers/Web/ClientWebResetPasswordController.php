...
class ClientWebResetPasswordController extends Controller
{
    use ResetsPasswords;
    ...
    public function reset(Request $request)
    {
        ...
        $response = $this->broker('clients')->reset(
     ...
     * @return void
     */
    protected function resetPassword($client, $password) 
    { 
        $this->setUserPassword($client, $password); 
