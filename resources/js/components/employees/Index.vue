          ...
          <table class="table-auto w-full border-collapse border border-custom-border">
            <thead class="thead-light bg-custom-bg_table_head_primary border-custom-border">
              <tr class="text-gray-600 border border-custom-border rounded-lg">
                ...
                <th class="text-left p-2 border border-custom-border">Role</th>
            ...
            <tbody v-else>
              <tr v-for="(data, index) in index.employees" :key="data.id">                
                <td class="p-2 border border-custom-border">{{ data.firstname }}</td>
                <td class="p-2 border border-custom-border">{{ data.lastname }}</td>
                ...
                <td class="text-truncate p-2 border border-custom-border">{{ data.role.role_name }}</td>
