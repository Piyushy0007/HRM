        ...
        <div style="margin-left: 242px;">
            <div class="p-8 bg-gray-50 min-h-screen">
                <div class="bg-white shadow-md rounded-lg p-6">
                    <h1
                        class="mb-4 text-center text-2xl font-semibold mb-4 text-blue-600"
                    >
                        Create Job Form
                    </h1>
                    <form
                        ...
                        <div v-if="step === 1">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    >
                                        Which option best describes this job's
                                        location?
    ...
    >
      ...
      >{{ uploadedFile.name }}</a>
                        ...
                        <div v-if="step === 2">
                            ...
                            <div class="mb-4 mt-4">
                                ...
                                >
                                    Number of People you wish to hire for this
                            ...
                            <div class="mb-4">
                                ...
                                >
                                    Recruitment timeline for this job<span
                                        class="text-red-500"
                                        >*</span
                                    >
                                </label>
                            ...
                            <div class="flex justify-between mt-4">
                                <button
                                    type="button"
                                    class="bg-gray-300 text-black px-6 py-2 rounded-lg hover:bg-gray-400"
                                    @click="prevStep"
                                >
                                    Back
                                </button>
                            ...
                            <div class="mb-6" style="margin-top: 2%;">
                                ...
                                >
                                    ...
                                    <div class="filter-options">
                                        ...
                                        <div
                                            v-for="(label,
                                            index) in scheduleTypes"
                                            :key="index"
                                            class="filter-option"
                                            :class="{
                                                active:
                                                    formData.schedule === label
                                            }"
                            ...
                            <div class="job-filter" style="margin-top: 8%;">
                                ...
                                <div class="filter-options">
                                    <div
                                        ...
                                        class="filter-option"
                                        :class="{
                                            active: formData.job_type === label
                                        }"
                            ...
                            <div class="job-filter" style="margin-top: 8%;">
                                ...
                                <div class="filter-options">
                                    <div
                                        ...
                                        class="filter-option"
                                        :class="{
                                            active: formData.benefits === label
                                        }"
            ...
            />
                        ...
                        <div v-if="step === 5">
                            ...
                            <div>
                                ...
                                >
                                    Review the pay we estimated for your job and
                                    adjust it as needed. Check your local
                                    minimum wage.
                                    <span
      ...
      >
        ...
        <option>Fixed Amount</option>
                            ...
                            <button
                                @click="addEmail"
                                class="text-blue-500 font-medium text-sm mb-4"
                            >
                                + Add email
                            </button>
                            ...
                            <div class="mb-4">
                                ...
                                >
                                    ...
                                    <span class="text-sm text-gray-800"
                                        >Plus, send an individual email update
                                        each time someone applies.</span
                                    >
                                </label>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                >
                                    <input
                                        ...
                                        id="contact"
                                        v-model="
                                            formData.communication_preference_email
                                        "
                                        class="h-5 w-5 text-blue-600 border-gray-300 rounded"
                                    />
                                    <span class="text-sm text-gray-800"
                                        >Let potential candidates contact you
                                        about this job</span
                                    >
                                </label>
                            </div>
