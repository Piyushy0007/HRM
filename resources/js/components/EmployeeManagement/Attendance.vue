<template>
    <div class="c-attendance-page px-4 pb-4 w-80" style="margin-right: 1vw;">
      <header-component />
  
      <div class="selection-function px-4 pt-2 pb-3 flex justify-between">
        <div class="text-right">
          <span class="block mb-1" style="float:left;">Monthly Attendance</span>
        </div>
      </div>
      ...
      <div class="information mx-4 mt-5 p-4 rounded-lg">
        ...
        <ul class="list-inside">
          <li>Attendance details for employees are displayed month-wise.</li>
        </ul>
      </div>
    </div>
  </template>
