<template>
    <div class="c-salary-page px-4 pb-4 w-80" style="margin-right: 1vw;">
      <header-component />
  
      <div class="selection-function px-4 pt-2 pb-3 flex justify-between">
        <div class="text-right">
          <span class="block mb-1" style="float:left;">Total Salaries</span>
        </div>
      </div>
      ...
      <div class="information mx-4 mt-5 p-4 rounded-lg">
        ...
        <ul class="list-inside">
          <li>All salary details are listed here.</li>
        </ul>
      </div>
    </div>
  </template>
