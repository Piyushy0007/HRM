...
import { required, email, integer, digits, alpha_spaces, min_value, max } from 'vee-validate/dist/rules'
...
import { faExternalLinkSquareAlt, faPencilAlt, faSearch, faColumns, faPlus, faUserPlus, faArrowCircleRight, faTimes, faBars, faEyeSlash, faEye, faPrint, faLock, faStar, faCalendarAlt } from '@fortawesome/free-solid-svg-icons';
import { faEnvelope, faListAlt, faCheckSquare, faSquare, faTrashAlt, faCalendar } from '@fortawesome/free-regular-svg-icons';
...
// Components
Vue.component('header-component', require('./components/shared/Header').default)
// Client header
Vue.component('client-header-component', require('./components/shared/ClientHeader').default)
...
const routes = [
	...
	},
	{
		...
		children: [
			...
			{
				path: 'notifications',
				component: require('./components/employees/Notifications.vue').default,
				name: 'employee-notifications'
			},
			{
				path: 'officer-logs',
				component: require('./components/employees/Officer-Logs.vue').default,
				name: 'officer-logs'
			},
			{
				path: 'deleted',
				component: require('./components/employees/Deleted.vue').default,
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				component: require('./components/client/MessagingChat.vue').default,
				name: 'cmsgchat',
			},
			{
				path: 'creport/',
				component: require('./components/client/_MainReport.vue').default,
				name: 'creport',
				redirect: 'creport/',
				children: [
					{
						path: '/',
						component: require('./components/client/HourlyReport.vue').default,
						name: 'HourlyReport'
					},
					{
						path: 'ticket',
						component: require('./components/client/ParkingTicket.vue').default,
						name: 'ticket'
					},
					{
						path: 'incident',
						component: require('./components/client/IncidentReport.vue').default,
						name: 'incident'  
					},
					{
						path: 'maintain',
						component: require('./components/client/MaintainReport.vue').default,
						name: 'maintain'
					},
					{
						path: 'sosreport',
